...
<div id="main-content">
  ...
  <form action="edit.php?id=<?php echo $user['id']; ?>" method="post">
    First name:<br />
    <input type="text" name="first_name" value="<?php echo u($user['first_name']); ?>" /><br />
    Last name:<br />
    <input type="text" name="last_name" value="<?php echo u($user['last_name']); ?>" /><br />
    Username:<br />
    <input type="text" name="username" value="<?php echo u($user['username']); ?>" /><br />
    Email:<br />
    <input type="text" name="email" value="<?php echo sanitize_email($user['email']); ?>" /><br />
    <br />
